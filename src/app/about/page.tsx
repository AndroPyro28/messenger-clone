...
export default function Home() {
  ...
  useEffect(() => {
    ...
    async function socketInitializer() {
      ...
      console.log(socket) // socket on initializer useEffect
      socket?.on('connect', () => {
        console.log('connected from client')
        
        socket?.on('WELCOME', (param) => {
          console.log(param)
        })
  ...
  useEffect(() => {
    console.log(socket) // socket on listeners useEffect
  ...
  return (
    <div className="flex items-center p-4 mx-auto min-h-screen justify-center bg-purple-500" onClick={() => {
      socket?.emit('CUSTOME_EVENT', 'andro')
    }}>
